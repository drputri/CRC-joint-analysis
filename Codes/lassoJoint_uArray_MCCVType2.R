...
save(rna.10, file = "Data/df_lasso_10uarray_MCCVType2.Rda")
...
save(df.uArray, file = "Data/df_lasso_uArray_MCCVType2.Rda")
...
#----------------------------------------------------------------------------------------
load("Data/df_lasso_uArray_MCCVType2.Rda")
...
save(out, file = "Data/jointLasso_uArray_MCCVType2.Rda")



## Calculate the data summary
load("Data/jointLasso_uArray_MCCVType2.Rda")
...
save(perf, file="Data/jointLasso_uArray_perf_MCCVType2.Rda")
