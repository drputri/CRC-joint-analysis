...
save(rna.10, file = "Data/df_lasso_10uarray_MCCVType1.Rda")
...
save(df.uArray, file = "Data/df_lasso_uArray_MCCVType1.Rda")
...
#----------------------------------------------------------------------------------------
load("Data/df_lasso_uArray_MCCVType1.Rda")
...
save(out, file = "Data/jointLasso_uArray_MCCVType1.Rda")



## Calculate the data summary
load("Data/jointLasso_uArray_MCCVType1.Rda")
library(tibble)
library(tidyr)
library(magrittr)
library(dplyr)
...
save(perf, file="Data/jointLasso_uArray_perf_MCCVType1.Rda")
